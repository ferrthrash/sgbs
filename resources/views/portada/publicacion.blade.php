...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>SGBS &mdash; Publicaciones</title>
			...
			<div class="container-fluid">
				...
				<div id="fh5co-navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="demoportada"><span>Inicio <span class="border"></span></span></a></li>
						<li class="active"><a href="publicacion"><span>Publicaciones <span class="border"></span></span></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-push-4">
					...
					<div class="row">
						<div class="col-md-6">
							<p><a href="img/portada/slide_1.jpg" class="image-popup"><img src="img/portada/slide_1.jpg" alt="FREEHTML5.co Free HTML5 Template" class="img-responsive img-rounded"></a></p>
						</div>
						<div class="col-md-6">
							<p><a href="img/portada/slide_2.jpg" class="image-popup"><img src="img/portada/slide_2.jpg" alt="FREEHTML5.co Free HTML5 Template" class="img-responsive img-rounded"></a></p>
						</div>
					</div>
				...
				<div class="col-md-4 col-md-pull-8">
					...
					<div class="fh5co-sidebox">
						<h3 class="fh5co-sidebox-lead">Noticias recientes</h3>	
						<ul class="fh5co-post">
							<li>
								<a href="#">
									<div class="fh5co-post-media"><img src="img/portada/slide_1.jpg" alt="FREEHTML5.co Free HTML5 Template"></div>
							...
							<li>
								<a href="#">
									<div class="fh5co-post-media"><img src="img/portada/slide_2.jpg" alt="FREEHTML5.co Free HTML5 Template"></div>
									<div class="fh5co-post-blurb">
										Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
										<span class="fh5co-post-meta">Oct. 12, 2015</span>
									</div>
							...
							<li>
								<a href="#">
									<div class="fh5co-post-media"><img src="img/portada/slide_3.jpg" alt="FREEHTML5.co Free HTML5 Template"></div>
									<div class="fh5co-post-blurb">
										Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
										<span class="fh5co-post-meta">Oct. 12, 2015</span>
									</div>
		...
		<div class="container">
			...
			<div class="row fh5co-row-padded fh5co-copyright">
				<div class="col-md-5">
					<p><small>&copy; SGBS 
						<!--
						<br> Designed by: <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a> | img/portada by: <a href="http://deathtothestockphoto.com/" target="_blank">DeathToTheStockPhoto</a> 
						-->
						</small></p>
